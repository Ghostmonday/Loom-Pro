...
This document is a **technical specification** intended to support a U.S. Provisional Patent Application filed pro se or through counsel. It is **not legal advice**. For pro se filing, use `legal/provisional-filing/` and `scripts/ops/build-provisional-pdf.sh`. Non-provisional conversion within 12 months may benefit from attorney review.
